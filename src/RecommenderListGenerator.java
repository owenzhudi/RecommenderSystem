...
public class RecommenderListGenerator {
	...
	public static class RecommendedListGeneratorReducer extends Reducer<IntWritable, Text, IntWritable, Text> {
		
		Map<Integer, String> movieTitles = new HashMap<>();
		// match movie name to movie_id
		@Override
		protected void setup(Context context) throws IOException {
			...
			Path pt = new Path(filePath);
			FileSystem fs = FileSystem.get(conf);
			BufferedReader bReader = new BufferedReader(new InputStreamReader(fs.open(pt)));
	...
	public static void main(String[] args) throws Exception {
		...
		job.setReducerClass(RecommendedListGeneratorReducer.class);
